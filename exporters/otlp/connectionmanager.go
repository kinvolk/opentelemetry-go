...
// ConnectionManager is an interface used by OTLP exporter. It's
...
type ConnectionManager interface {
	...
	ExportMetrics(parent context.Context, cps metricsdk.CheckpointSet, selector metricsdk.ExportKindSelector) error
